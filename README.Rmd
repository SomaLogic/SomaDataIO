...
[![Codecov test coverage](https://app.codecov.io/gh/SomaLogic/SomaDataIO/branch/master/graph/badge.svg)](https://app.codecov.io/gh/SomaLogic/SomaDataIO?branch=master)
...
The package provides auxiliary functions for manipulating, wrangling, and
extracting relevant information from the ADAT object once in the R environment.
...
The `SomaDataIO` package comes with 4 objects available
